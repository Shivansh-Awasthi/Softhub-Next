...
const SearchResults = ({ initialData = null }) => {
    ...
    // Removed user data loading that might be causing issues
        ...
        <div>
            ...
            {loading ? (
                ...
                <div>
                    ...
                    <div className="p-6 bg-[#2c2c2c] rounded-lg text-sm text-center border border-white border-opacity-10 shadow-lg max-w-4xl mx-auto">
                        <p>{error}</p>
                    </div>
                </div>
            ) : data.length === 0 ? (
                ...
                <div className="w-full md:w-full pt-3 pb-3 border border-gray-200 border-opacity-5 bg-[#262626] rounded-lg shadow ">
                    <div className="flow-root">
                        <ul role="list" className="divide-y divide-gray-700">
                            {data.map((ele) => {
                                // Removed lock checking logic that might be causing issues

                                return (
                                    <li
                                        key={ele._id}
                                        className="py-2 sm:py-2 p-8 relative hover:bg-[#2E2E2E]"
                                    >
                                        <a
                                        ...
                                        {/* Removed lock icon that might be causing issues */}
                                    </li>
                                );
                            })}
                        </ul>
