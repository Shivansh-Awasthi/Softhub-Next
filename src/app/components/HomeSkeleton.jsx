  ...
  return (
    <div className="animate-pulse">
      ...
      <div className="relative w-full mb-10">
        <div className="relative h-56 sm:h-72 md:h-88 lg:h-[25rem] overflow-hidden rounded-lg bg-gray-700">
        ...
        <div className="absolute flex space-x-2 bottom-7 left-1/2 transform -translate-x-1/2">
          {[1, 2, 3, 4].map((_, index) => (
            <div key={index} className="w-8 h-1 rounded-full bg-gray-600"></div>
          ))}
        </div>
      </div>
