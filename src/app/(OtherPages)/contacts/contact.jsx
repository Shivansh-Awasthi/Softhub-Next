...
const faqData = [
    {
        ...
        answer: `If you want assistance in installing any app then simply join out <a class="text-cyan-500" href="https://t.me/downloadmacgames" target="_blank" rel="noopener noreferrer">Telegram</a> and contact the Admins there.`
    },
    {
        question: "Information for copyright holders (DMCA)",
        answer: `If you are the copyright holder of materials (texts, photographs or other objects of copyright) posted on the Site and/or your rights are in any other way violated by the materials of the Site, please send a corresponding request to the Site Administration to the e-mail address <a class="text-blue-500" href="mailto:support@toxicgames.in" target="_blank" rel="noopener noreferrer">support@toxicgames.in</a> and provide comprehensive evidence of ownership of the exclusive right to the relevant materials (works) and/or other information and data on the essence of the violation of rights.
    ...
    },
    {
        ...
        answer: `Users with working releases can share them on  <a class="text-cyan-500" href="https://t.me/downloadmacgames" target="_blank" rel="noopener noreferrer">Telegram</a> `
    },
    {
        question: "Development and design",
        answer: `Developer: <a class="text-purple-500" href="https://t.me/downloadmacgames" target="_blank" rel="noopener noreferrer">#VenomX</a>.<br /> <br />
    Design: <a class="text-purple-500" href="https://t.me/downloadmacgames" target="_blank" rel="noopener noreferrer">#VenomX</a>`
    }
];
